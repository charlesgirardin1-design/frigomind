...
export const COMMON = {
  fr: {
    ...
    recipe: {
      ...
      ingredientsNotUsed: 'Ingrédients non utilisés',
      ...
      stepsServingsNote: (n) => `📏 Les quantités mentionnées dans les étapes correspondent à la recette originale, pour ${n} personnes.`,
  ...
  en: {
    ...
    recipe: {
      ...
      ingredientsNotUsed: 'Ingredients not used',
      ...
      stepsServingsNote: (n) => `📏 The quantities mentioned in the steps match the original recipe, for ${n} servings.`,
