...
const DESCRIPTIONS = {
  fr: {
    ...
    recipesBrowse: 'Recherchez et filtrez librement parmi plus de 750 recettes, y compris des plats du monde entier.',
  ...
  en: {
    ...
    recipesBrowse: 'Search and filter freely across 750+ recipes, including dishes from around the world.',
