...
const STRINGS = {
  fr: {
    ...
    sources:
      "Sources : UNEP Food Waste Index Report 2024 (chiffres mondiaux, données 2022) ; ADEME (France) ; WRAP (Royaume-Uni) ; RTS / USDA (États-Unis) ; Thünen Institute (Allemagne) ; Waste Watcher / OWW-IT (Italie) ; FAO / UNEP (coût économique). Les méthodologies de mesure diffèrent selon les pays (déclaratif vs. analyse des déchets), ces chiffres sont donc des ordres de grandeur plutôt qu'une comparaison stricte.",
  ...
  en: {
    ...
    sources:
      'Sources: UNEP Food Waste Index Report 2024 (global figures, 2022 data); ADEME (France); WRAP (UK); RTS / USDA (US); Thünen Institute (Germany); Waste Watcher / OWW-IT (Italy); FAO / UNEP (economic cost). Measurement methodologies differ by country (self-reported diaries vs. waste analysis), so these figures are rough estimates rather than a strict comparison.',
