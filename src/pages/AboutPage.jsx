...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-8 pb-16 animate-fadeIn">
      ...
      <h2 className="text-2xl font-bold text-neutral-900">À propos de FrigoMind</h2>

      <div className="mt-5 space-y-5 text-neutral-600 leading-relaxed">
        <p>
        ...
        <div className="card p-5">
          <h3 className="font-semibold text-neutral-900 mb-2">🥕 Notre mission anti-gaspi</h3>
          <p className="text-sm">
            En France, un foyer jette en moyenne plusieurs dizaines de kilos de nourriture par an, souvent
            par manque d'idée plutôt que par manque d'envie de cuisiner. FrigoMind priorise les
        ...
        <div>
          <h3 className="font-semibold text-neutral-900 mb-2">📸 Comment ça marche</h3>
        ...
        <div>
          <h3 className="font-semibold text-neutral-900 mb-2">🔒 Vos photos</h3>
          <p className="text-sm">
