...
const STRINGS = {
  fr: {
    prompt: '🧠 Avez-vous aussi l\'un de ces ingrédients ? Cochez ce que vous avez pour affiner vos recettes.',
  },
  en: {
    prompt: '🧠 Do you also have any of these ingredients? Check what you have to refine your recipes.',
  },
}
...
export default function IngredientSuggestions({ suggestions, onSelect }) {
  ...
  return (
    <div className="mt-4 card p-4">
      <p className="text-sm font-medium text-neutral-700">{STRINGS[lang].prompt}</p>
